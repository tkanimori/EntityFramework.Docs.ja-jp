...
ms.locfileid: "75781015"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Entity Framework ドキュメント</h1>
        <ul class="pivots">
            <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>EF Core は Entity Framework の軽量版であり、拡張性に優れ、プラットフォームに依存しません。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>EF6 は試験の結果、信頼性が立証されたデータ アクセス テクノロジです。何年にもわたり機能が蓄積され、安定しています。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>EF Core に移植</h3>
                                                    <p>既存の EF 6 アプリケーションを EF Core に移植する方法に関するガイダンスです。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/ef/core/modeling/">モデルを作成する</a>
                                                </p>
                                                <p>
                                                    <a href="/ef/core/querying/">データのクエリ</a>
                                                </p>
                                                <p>
                                                    <a href="/ef/core/saving/">データの保存</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/ef/core/get-started/">チュートリアル</a>
                                                </h3>
                                                <p>
                                                    <a href="/ef/core/get-started/">その他...</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/ef/core/providers/">データベース プロバイダー</a>
                                                </h3>
                                                <p>
                                                ...
                                                <p>
                                                    <a href="/ef/core/providers/">その他...</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://docs.microsoft.com/dotnet/api/?view=efcore-2.1">API リファレンス</a>
                                                </h3>
                                                <p>
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/dotnet/api/?view=efcore-2.1">その他...</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API リファレンス</h3>
                                                    <p>名前空間別に整理されている Entity Framework 6 API を参照します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
