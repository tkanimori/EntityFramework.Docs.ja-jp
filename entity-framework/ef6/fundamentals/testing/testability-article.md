...
Scott Allen は、Pluralsight の技術スタッフのメンバーと OdeToCode.com の創設者です。 商用ソフトウェア開発の 15 年間は、ASP.NET web アプリケーションを非常にスケーラブルな 8 ビットの組み込みデバイスからすべてのソリューションで Scott、努めてきました。 Scott は、OdeToCode、彼のブログや Twitter は、上に到達できる\<http://twitter.com/OdeToCode>します。
