...
MSL で参照されるすべての概念モデル型またはストレージ モデル型の名前は、それぞれの名前空間名で修飾する必要があります。 概念モデル名前空間の名前については、[CSDL 仕様](~/ef6/modeling/designer/advanced/edmx/csdl-spec.md)を参照してください。 ストレージ モデル名前空間の名前については、[SSDL 仕様](~/ef6/modeling/designer/advanced/edmx/ssdl-spec.md)を参照してください。
