...
| 属性名   | 必須 | 値                                                                                                                                                                                                                                                                                                                                                                                                              |
|:-----------------|:------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **型**         | はい         | アソシエーションの一方の End のエンティティ型の名前。                                                                                                                                                                                                                                                                                                                                                         |
| **ロール**         | いいえ          | アソシエーション End の名前。 名前が指定されない場合、アソシエーション End のエンティティ型の名前が使用されます。                                                                                                                                                                                                                                                                                           |
| **要素** | はい         | **1**、 **0 ..1**、またはアソシエーションの最後にあるエンティティ型のインスタンスの数に応じて **\*** ます。 <br/> **1**は、アソシエーション end に1つのエンティティ型インスタンスが存在することを示します。 <br/> **0 ..1**は、アソシエーション end に0個または1個のエンティティ型インスタンスが存在することを示します。 <br/> **\*** は、アソシエーション end に0個以上のエンティティ型インスタンスが存在することを示します。 |
...
| 属性名 | 必須 | 値                                                                                                                                                                                                                         |
|:---------------|:------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **動作**     | はい         | **Cascade**または**None**。 **Cascade**を指定すると、プリンシパルエンティティ型が削除されるときに依存エンティティ型が削除されます。 存在**しない場合、** プリンシパルエンティティ型が削除されても依存エンティティ型は削除されません。 |
...
|:---------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **名前**       | はい         | パラメーターの名前。                                                                                                                                                                                                      |
| **型**       | はい         | パラメーターの型。 この値は、 **Edmsimpletype**またはモデルのスコープ内にある複合型である必要があります。                                                                                                             |
...
|:-----------------------------------------------------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **名前**                                                               | はい         | プロパティの名前。                                                                                                                                                                                                       |
| **型**                                                               | はい         | プロパティ値の型です。 プロパティ値の型は、 **Edmsimpletype**であるか、モデルのスコープ内にある複合型 (完全修飾名で示される) である必要があります。                                                 |
...
| ファセット               | 説明                                                                                                                                                                                                                                                   | 状態名                                                                                                                                                                                                                                                                                                                                                                           | データベースの生成に使用 | ランタイムで使用 |
|:--------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------|:--------------------|
