...
> [!NOTE]
> このページは、EF Designer を使用して、モデル内の関係を設定する方法についての情報を提供します。 EF とアクセスし、リレーションシップを使用してデータを操作する方法に関係の詳細については、[リレーションシップとナビゲーション プロパティ](~/ef6/fundamentals/relationships.md)を参照してください。
