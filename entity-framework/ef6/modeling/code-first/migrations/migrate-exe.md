...
| エラー: ファイルまたはアセンブリ '&lt;assemblyName&gt;'、またはその依存関係の1つを読み込むことができませんでした。 正しくない形式のプログラムを読み込もうとしました。                                                                                                                                                                          | これは、x64 アプリケーションに対して migrate を実行しようとした場合に発生します。 EF 5.0 以降は、x86 でのみ機能します。                                                                                                                                                                                |
