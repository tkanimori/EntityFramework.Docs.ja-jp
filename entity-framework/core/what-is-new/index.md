...
- [EF Core ロードマップ](xref:core/what-is-new/roadmap)

## <a name="recent-releases"></a>最近のリリース

- [EF Core 2.1 (現在プレビュー中)](xref:core/what-is-new/ef-core-2.1)
- [EF Core 2.0 (最新リリース バージョン)](xref:core/what-is-new/ef-core-2.0)
