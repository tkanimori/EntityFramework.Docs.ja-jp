...
> [!TIP]  
> この記事を表示する[サンプル](https://github.com/aspnet/EntityFramework.Docs/tree/master/samples/core/Saving/Saving/Disconnected/)GitHub でします。
...
キーの値が自動的に生成されたいないときに、新しいエンティティを識別するその他の機構が必要です。 この 2 つの一般的な方法があります。
 * エンティティのクエリ
 * クライアントから、フラグを渡します
