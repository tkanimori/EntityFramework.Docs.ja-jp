...
| パラメーター                | 説明                                                                                                                                                                                                                |
|:-------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *-From*\<String>        | 開始の移行。 移行は名前または ID で識別される可能性があります。 数値 0 は特殊なケースでは意味*最初の移行の前に*します。 既定値は 0 です。                                                              |
| *-To* \<String>          | 終了の移行。 移行の最後の既定値します。                                                                                                                                                                      |
| <nobr>-Idempotent</nobr> | すべての移行でのデータベースで使用できるスクリプトを生成します。                                                                                                                                                         |
